...
class Boat:
    ...
    В нем описываеться основной функционал лодки. Можно добавить и брать гребцов, 
    загрузить и разгрухить лодку. Повернуть лодку, начать движение, опустить и поднять якорь
    
    Так же есть разные типы лодок, которым свойствены свои индвидиульные харакетристики 
    (повышенная скорость, повышеная вместимость и тд)
    """
